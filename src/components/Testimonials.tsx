...
const Testimonials = () => (
  <section className="py-8 md:py-12 bg-background overflow-hidden">
    <div className="container">
      ...
      {/* Marquee */}
      <Marquee pauseOnHover className="[--duration:40s] [mask-image:linear-gradient(to_right,transparent_0%,black_10%,black_90%,transparent_100%)]">
        {testimonials.map((t, i) => (
          <div
            key={t.name}
            className="w-72 shrink-0 bg-card border border-border rounded-2xl p-5 mx-2 flex flex-col gap-4
